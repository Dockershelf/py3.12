...
Debian packaging for CPython 3.12: patches, `debiandirs/`, and changelog tracks used by the [Dockershelf python-pipeline](https://github.com/Dockershelf/python-pipeline).
...
```bash
make materialize PY=3.12 DIST=trixie
make build PY=3.12 DIST=trixie
```
